...
async function GET(request) {
    try {
        ...
        const reactions = await db.collection("reactions").find({
            contentId,
            contentType
        }).toArray();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(reactions);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__374a891c._.js.map