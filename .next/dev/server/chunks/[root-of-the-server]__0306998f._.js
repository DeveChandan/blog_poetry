...
"[project]/app/api/user/reactions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const userReactions = await db.collection("reactions").find({
            userId: session.userId
        }).sort({
            createdAt: -1
        }).toArray();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(userReactions);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0306998f._.js.map