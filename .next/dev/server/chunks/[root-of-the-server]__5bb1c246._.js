...
async function GET() {
    try {
        ...
        const books = await db.collection("books").find({}).sort({
            createdAt: -1
        }).toArray();
...
async function POST(request) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revalidatePath"])('/books');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5bb1c246._.js.map