...
"[project]/app/api/user/comments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const userComments = await db.collection("comments").find({
            userId: session.userId
        }).sort({
            createdAt: -1
        }).toArray();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(userComments);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e6043d0._.js.map