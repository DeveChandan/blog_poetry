...
"[project]/app/api/poems/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const poems = await db.collection("poems").find({}).sort({
            createdAt: -1
        }).toArray();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(poems);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const result = await db.collection("poems").insertOne({
            ...
            author: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](session.userId),
            tags: tags || [],
            featured: false,
            createdAt: new Date(),
            updatedAt: new Date(),
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revalidatePath"])('/poems');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5dc54411._.js.map