            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                {selectedCoverFile && (
                  <p className="text-sm text-muted-foreground mt-1">
                    Selected cover file: {selectedCoverFile.name} (will be uploaded on submit)
                  </p>
                )}
              ...
              <div className="flex gap-4">
                <Button type="submit" disabled={loading || uploading || uploadingCover}>
                  {uploadingCover ? "Uploading Cover..." : uploading ? "Uploading E-book..." : loading ? "Creating..." : "Add Book"}
                </Button>
